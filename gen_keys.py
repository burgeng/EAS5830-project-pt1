...
def sign_message(challenge, filename="secret_key.txt"):
    ...
    assert private_key, "Your account secret_key.txt is empty"

    w3 = Web3()
    message = encode_defunct(challenge)

    # recover account info from private key
    ...
    # return signed_message- account associatd with the private key
